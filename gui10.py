...
class Page10:
    def __init__(self,p1w):
      self.p1w=p1w
      self.p1w.geometry("1073x726+100+0")
      self.p1w.configure(bg = "#FFFFFF")
    ...
    #   )
      ...
      self.added_path = Entry(self.p1w,
          bd=0,
          bg="#D9D9D9",
          fg="#000716",
          highlightthickness=0
      ...
      self.p1w.resizable(False, False)
...
#-----------------------------------------------------
    ...
    def copy_path(self):
        try:
            ...
            self.p1w.clipboard_clear()  # Clear the clipboard
            self.p1w.clipboard_append(text)  # Copy text to the clipboard
    ...
    def exit(self):
        win=Toplevel(self.p1w)
        gui0.Page0(win)
        self.p1w.withdraw()
        win.deiconify()
    def next(self):
        prw=Toplevel(self.p1w)
        gui9.Page9(prw)
        self.p1w.withdraw()
        prw.deiconify()
    def skip(self):
